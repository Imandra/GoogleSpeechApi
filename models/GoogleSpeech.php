...
class GoogleSpeech
{
    ...
    public function voiceToText($file)
    {
        ...
        $result = $this->request($file_to_upload);
     ...
     * @return string
     */
    private function request($file_to_upload = array())
    {
        curl_setopt_array($this->ch, array(
            CURLOPT_URL => 'https://www.google.com/speech-api/v2/recognize?output=json&lang=ru-RU&key=' . $this->api_key,
            CURLOPT_SSL_VERIFYPEER => 0,
            CURLOPT_POST => 1,
            CURLOPT_HTTPHEADER => array('Content-Type: audio/x-flac; rate=22000;'),
